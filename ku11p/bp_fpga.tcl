...
#
# Generated by Vivado on Thu Jun 04 18:03:06 PDT 2020
...
proc cr_bd_design_2 { parentCell } {
  ...
  set gate1 [ create_bd_port -dir I gate1 ]
  set gate2 [ create_bd_port -dir I gate2 ]
  set raw1 [ create_bd_port -dir I raw1 ]
  set raw2 [ create_bd_port -dir I raw2 ]
  ...
  connect_bd_net -net gate1_1 [get_bd_ports gate1] [get_bd_pins ila_0/probe2]
  connect_bd_net -net gate2_1 [get_bd_ports gate2] [get_bd_pins ila_0/probe4]
  connect_bd_net -net raw1_1 [get_bd_ports raw1] [get_bd_pins ila_0/probe1]
  connect_bd_net -net raw2_1 [get_bd_ports raw2] [get_bd_pins ila_0/probe3]
